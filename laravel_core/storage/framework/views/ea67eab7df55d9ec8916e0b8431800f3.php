...
<body class="bg-gray-50 text-gray-900 dark:bg-black dark:text-white">
    ...
    <nav class="relative z-50 p-8 max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center gap-10">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="bg-[#f59e0b] text-black px-6 py-3 text-[10px] font-black tracking-[0.2em] hover:bg-[#d97706] transition uppercase shadow-md dark:shadow-none">Contacto</a>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" class="absolute top-24 left-8 right-8 bg-white dark:bg-[#050505] border border-gray-100 dark:border-white/10 p-8 flex flex-col gap-6 text-center md:hidden shadow-2xl rounded-xl dark:rounded-none z-50" style="display: none;" @click.away="mobileMenuOpen = false">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="block bg-[#f59e0b] text-black py-4 text-[12px] font-black tracking-[0.3em] uppercase rounded-lg dark:rounded-none">Contacto</a>
        </div>
    </nav>
    ...
    <section id="funciones-gestor" class="py-32 border-t border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-[#020202]">
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $adminFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="feature-card">
                    <div class="img-container-pc group" ondblclick="openFullscreen(this)">
                        <video src="/images/<?php echo e($feature['video']); ?>" loop muted playsinline class="img-pc"></video>
                    ...
                    <div class="p-8">
                        <h4 class="font-bold uppercase mb-2 tracking-widest text-sm text-gray-900 dark:text-white"><?php echo e($feature['title']); ?></h4>
                        <p class="text-gray-500 text-xs leading-relaxed uppercase"><?php echo e($feature['desc']); ?></p>
                    </div>
                </div>
        ...
        <div class="max-w-4xl mx-auto px-8 text-center">
            ...
            <div class="border border-gray-200 dark:border-white/10 p-12 bg-white dark:bg-black shadow-xl dark:shadow-none rounded-xl dark:rounded-none relative overflow-hidden">
                ...
                <div class="flex flex-col items-center gap-8">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="text-[10px] tracking-[0.4em] uppercase text-gray-500 hover:text-[#f59e0b] dark:text-gray-600 dark:hover:text-[#f59e0b] transition italic border-b border-gray-200 dark:border-white/5 pb-1">¿Tienes dudas? Habla con nosotros</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="p-20 text-center text-gray-500 dark:text-gray-700 text-[10px] tracking-[0.3em] uppercase border-t border-gray-200 dark:border-white/5 bg-white dark:bg-black">
        ...
        <div class="flex flex-wrap justify-center gap-6 opacity-80 dark:opacity-50 hover:opacity-100 transition-opacity">
            <a href="<?php echo e(route('contact')); ?>" class="hover:text-gray-900 dark:hover:text-white transition">Contacto</a>
            <a href="<?php echo e(route('legal.terms')); ?>" class="hover:text-gray-900 dark:hover:text-white transition">Aviso Legal</a>
            <a href="<?php echo e(route('legal.privacy')); ?>" class="hover:text-gray-900 dark:hover:text-white transition">Privacidad</a>
            <a href="<?php echo e(route('legal.cookies')); ?>" class="hover:text-gray-900 dark:hover:text-white transition">Cookies</a>
        </div>
    </footer>
...
<?php /**PATH C:\Users\Trending Pc\Documents\dciengestionbox.es\laravel_core\resources\views/welcome.blade.php ENDPATH**/ ?>